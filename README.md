...
```sh
curl -LO https://github.com/lemire/simdsearch/releases/download/v0.3.1/simdsearch.h
curl -LO https://github.com/lemire/simdsearch/releases/download/v0.3.1/SHA256SUMS
