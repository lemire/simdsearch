...
```sh
curl -LO https://github.com/lemire/simdsearch/releases/download/v0.3.0/simdsearch.h
curl -LO https://github.com/lemire/simdsearch/releases/download/v0.3.0/SHA256SUMS
